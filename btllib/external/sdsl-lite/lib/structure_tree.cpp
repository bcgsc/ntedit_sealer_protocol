...
std::string create_html_header(const char* file_name)
{
    ...
    jsonheader
            ...
            << "    <script src=\"file:///projects/btl/vnikolic/projects/2022/sealer-protocol-clean/ntedit-sealer-longread/btllib/external/sdsl-lite/external/d3/d3.min.js\"></script>"
